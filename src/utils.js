...
// ⚡ Bolt: Extract time parsing regex to avoid recompilation overhead inside loops (used heavily for hourly forecasts)
const TIME_REGEX = /^(?<hour>\d{1,2}):(?<minute>\d{2})(?::(?<second>\d{2}))?$/;
